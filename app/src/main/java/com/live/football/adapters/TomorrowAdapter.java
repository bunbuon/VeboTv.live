...
public class TomorrowAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TomorrowAdapter(Activity activity, List<RootDataListMatch> infos) {
        mActivity = activity;
